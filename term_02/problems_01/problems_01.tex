...
\problemItemSimple[*]
{%
Праз $P^c_n\ (n \ge 1)$ абазначым мноства ўсіх булевых функцый, якія залежаць ад зменных $x_1, x_2, \ldots, x_n$ і пры гэтым ад кожнай зменнай істотным чынам.
\begin{belarusianEnumerate}
    \item Выпішыце ўсе функцыі мноства $P^c_2$;
    \item Знайдзіце колькасць элементаў мноства $P^c_3$;
    \item Дакажыце, што $|P^c_n|=\sum\limits_{k=0}^n (-1)^kC_n^k2^{2^{n-k}}$.
\end{belarusianEnumerate}\\
}
{%
